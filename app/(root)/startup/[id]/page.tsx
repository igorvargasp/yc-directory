...
const page = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const [post, {select: editorPosts}] = await Promise.all([await client.fetch(STARTUPS_BY_ID_QUERY, { id }),await client.fetch(PLAYLIST_BY_SLUG_QUERY, {
    slug: "pitch-of-the-day",
  })])
